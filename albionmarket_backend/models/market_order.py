...
class MarketOrder(db.Model):
    ...
    def __init__(self, order_id, item_id, location_id, quality, enchantment, price, amount, expire):
        self.id = order_id
    ...
    @classmethod
    def create_or_update(cls, order_id, item_id, location_id, quality, enchantment, price, amount, expire):
        market_order = MarketOrder.query.get(order_id)

        if market_order is None:
            market_order = cls(order_id, item_id, location_id, quality, enchantment, price, amount, expire)
